...
export const metadata: Metadata = {
  title: "자주 묻는 질문",
  description:
    "가입 절차, 보험료 절감 원리, 취급 상품, 개인정보 처리에 대한 자주 묻는 질문을 모았습니다.",
};
...
const GROUPS = [
  {
    ...
    items: [
      ...
      {
        q: "계산기에 나온 금액으로 가입되나요?",
        a: "계산기 결과는 평균 절감률을 적용한 참고용 추정치입니다. 실제 보험료는 보험사·상품·연령·성별·직업·가입 담보 및 인수 심사 결과에 따라 달라지며, 최종 금액은 상담 단계에서 안내해 드립니다.",
      },
      {
    ...
    items: [
      {
        ...
        a: "네. 나무파트너스는 특정 상품을 권유하지 않고 국내 보험사의 상품을 두루 취급합니다. 신청 시 알아보신 보험사와 상품명을 적어 주시면 같은 상품으로 가입 가능한지 확인해 안내해 드립니다. 다만 보험사·상품에 따라 단체 가입이 제한되거나 인수 조건이 다를 수 있습니다.",
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      {
        q: "내 정보가 협약단체에 전달되나요?",
        a: "아닙니다. 협약단체에는 개인을 식별할 수 없는 집계 수치(신청 건수, 성사 건수)만 제공됩니다.",
      },
      {
        q: "개인정보는 얼마나 보관되나요?",
